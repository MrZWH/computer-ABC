...
- 计算机网络
    ...
    - 数据链路层
      ...
      - 数据链路层的差错监测
        ...
        - 循环冗余校验码CRC
          ...
          - 例子1：使用CRC计算101001的可检验位串
            ...
            - 第二步：![CRC计算可校验位串2](./images/CRC计算可校验位串2.png)
      ...
      - 以太网协议（数据链路层常用的协议）
        ...
        - 以太网协议
          ...
          - ![以太网数据格式](./images/以太网数据格式.png)
          - ![MAC地址表](./images/MAC地址表.png)
          - ![MAC地址表作用](./images/MAC地址表作用.png)
          - ![当路由器不知道MAC地址时数据包的处理过程](./images/当路由器不知道MAC地址时数据包的处理过程.png)
    - 底层协议
  - 网络层篇
    - ![怎么跨设备传输](./images/怎么跨设备传输.png)
      ...
      - IP 协议详解
        ...
        - IP协议的转发流程
          ...
          - 路由表简介
            - ![路由表](./images/路由表.png)
          - IP协议的转发流程
            - ![IP协议转发流程](./images/IP协议转发流程.png)
            - ![IP协议转发流程2](./images/IP协议转发流程2.png)
            - ![IP协议转发流程3](./images/IP协议转发流程3.png)
    ...
    - 网络层其他协议
      - ARP协议与RARP协议
        - ARP（Address Resolution Protocol）地址解析协议
          ...
          - ![ARP协议数据结构](./images/ARP协议数据结构.png)
    ...
    - IP的路由算法
      ...
      - 内部网关路由协议
        ...
        - Dijkstra（迪杰斯特拉）算法
          ...
          - ![最短路径问题](./images/最短路径问题.png)
          - ![Dijkstra算法文字描述](./images/Dijkstra算法文字描述.png)
          - ![Dijkstra算法文字图解1](./images/Dijkstra算法文字图解1.png)
          - ![Dijkstra算法文字图解2](./images/Dijkstra算法文字图解2.png)
          - ![Dijkstra算法文字图解3](./images/Dijkstra算法文字图解3.png)
          - ![Dijkstra算法文字图解4](./images/Dijkstra算法文字图解4.png)
          - ![Dijkstra算法文字图解5](./images/Dijkstra算法文字图解5.png)
        - OSPF协议
          - 链路状态（LS）协议
            - ![链路状态（LS）协议](./images/链路状态（LS）协议.png)
            - ![链路状态（LS）协议特点2](./images/链路状态（LS）协议特点2.png)
            - 只有链路状态发生变化时，才发送更新信息
          - OSPF协议的过程
            - OSPF（Open Shortest Path First：开放最短路径优先）
            - OSPF协议的核心是Dijkstra算法，是链路状态（LS）协议的一种实现
            - 每个路由器都能获得网络的完整拓扑
            - ![OSPF协议的过程1](./images/OSPF协议的过程1.png)
            - ![OSPF协议的过程2](./images/OSPF协议的过程2.png)
            - ![OSPF协议的过程3](./images/OSPF协议的过程3.png)
            - OSPF协议的五种消息类型：
              ...
              - 链路状态更新信息
              - 链路状态确认消息
            - ![OSPF协议的完整过程](./images/OSPF协议的完整过程.png)
            - ![RIP与OSPF对比](./images/RIP与OSPF对比.png)
      - 外部网关路由协议
        - BGP协议
          ...
          - ![BGP发言人](./images/BGP发言人.png)
          - ![AS可通过BGP发言人自行配置](./images/AS可通过BGP发言人自行配置.png)
          - ![结合CIDR](./images/结合CIDR.png)
  ...
  - 应用层篇
    ...
    - HTTP（HyperText Transfer Protocol）超文本传输协议，带超链接的文本其实也是一个富文本的表现形式，可以有图片动图视频，web服务就是提供内容的服务，对内容都有一个路径
      ...
      - ![web服务器](./images/web服务器.png)
      - ![web服务器步骤](./images/web服务器步骤.png)
      ...
      - 如何指定资源：
        - 在地址中指定
        - 在请求数据中指定
      - ![请求报文与应答报文](./images/请求报文与应答报文.png)
      - ![状态码](./images/状态码.png)
    - HTTP工作的结构
      - Web缓存
        - ![web缓存](./images/web缓存.png)
      - Web代理
        - ![web代理](./images/web代理.png)
        - ![正向代理](./images/正向代理.png)
        - ![反向代理](./images/反向代理.png)
        - ![理解代理](./images/理解代理.png)
    ...
    - HTTPS协议详解
      ...
      - 数字证书：
        - 数字证书是**可信任组织**颁发给**特点对象**的认证
        - ![数字证书](./images/数字证书.png)
      - SSL(Secure Sockets Layer:安全套接层)
        - 介于应用层与传输层之间
        - 数据安全和数据完整，不会泄漏和被篡改。
        - 对传输层数据进行加密后传输
      - ![https传输过程](./images/https传输过程.png)
      - ![SSL安全参数握手1](./images/SSL安全参数握手1.png)
      - ![SSL安全参数握手2](./images/SSL安全参数握手2.png)
    - URL 资源
    - HTTP 结构
    - HTTPS 安全
    - HTTP 服务
